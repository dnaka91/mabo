...
/// The output of generating converting a schema file into one or more Kotlin source code files. The
/// files' content solely resides in this structure and still needs to be saved to the file system.
///
/// As Kotlin doesn't allow to directly define modules within a single file, a tree structure is
...
pub struct Output<'a> {
    ...
    pub name: &'a str,
    /// Final Kotlin source code output of the module file.
    pub content: String,
