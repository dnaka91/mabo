    ...
    if fields.kind == FieldKind::Unit {
        ...
        let calls = fields.fields.iter().map(|Field { name, ty, id, .. }| {
            ...
            if let Type::Option(ty) = &ty {
                ...
                quote! {
                    ::stef::buf::size_field_option(#id, #name.as_ref(), |v| { #ty })
                }
            } else {
...
pub(crate) fn compile_data_type(opts: &Opts, ty: &Type<'_>, name: TokenStream) -> TokenStream {
    match &ty {
        Type::Bool => quote! { ::stef::buf::size_bool(*#name) },
        Type::U8 => quote! { ::stef::buf::size_u8(*#name) },
        Type::U16 => quote! { ::stef::buf::size_u16(*#name) },
        Type::U32 => quote! { ::stef::buf::size_u32(*#name) },
        Type::U64 => quote! { ::stef::buf::size_u64(*#name) },
        Type::U128 => quote! { ::stef::buf::size_u128(*#name) },
        Type::I8 => quote! { ::stef::buf::size_i8(*#name) },
        Type::I16 => quote! { ::stef::buf::size_i16(*#name) },
        Type::I32 => quote! { ::stef::buf::size_i32(*#name) },
        Type::I64 => quote! { ::stef::buf::size_i64(*#name) },
        Type::I128 => quote! { ::stef::buf::size_i128(*#name) },
        Type::F32 => quote! { ::stef::buf::size_f32(*#name) },
        Type::F64 => quote! { ::stef::buf::size_f64(*#name) },
        ...
        Type::NonZero(ty) => match &**ty {
            Type::U8 => quote! { ::stef::buf::size_u8(#name.get()) },
            Type::U16 => quote! { ::stef::buf::size_u16(#name.get()) },
            Type::U32 => quote! { ::stef::buf::size_u32(#name.get()) },
            Type::U64 => quote! { ::stef::buf::size_u64(#name.get()) },
            Type::U128 => quote! { ::stef::buf::size_u128(#name.get()) },
            Type::I8 => quote! { ::stef::buf::size_i8(#name.get()) },
            Type::I16 => quote! { ::stef::buf::size_i16(#name.get()) },
            Type::I32 => quote! { ::stef::buf::size_i32(#name.get()) },
            Type::I64 => quote! { ::stef::buf::size_i64(#name.get()) },
            Type::I128 => quote! { ::stef::buf::size_i128(#name.get()) },
            Type::String
            | Type::StringRef
            | Type::Bytes
            | Type::BytesRef
